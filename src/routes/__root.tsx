...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Zetaa Technologies — Trusted Security Services" },
      ...
      { name: "author", content: "Zetaa Technologies" },
      { property: "og:title", content: "Zetaa Technologies — Trusted Security Services" },
      { name: "twitter:title", content: "Zetaa Technologies — Trusted Security Services" },
